...
export const Route = createFileRoute("/admin-login")({
  head: () => ({
    meta: [
      { title: "Admin Login — Youth Parliament 6.0" },
      { name: "description", content: "Secure administrator access to the Youth Parliament 6.0 registration portal." },
...
function AdminLogin() {
  ...
  return (
    <AuthCard eyebrow="Administration" title="Admin Login" subtitle="Access participant records, analytics and event controls.">
      <form onSubmit={onSubmit} className="grid gap-5">
        <label className="block">
          <span className="text-[11px] font-semibold tracking-[0.18em] uppercase text-muted-foreground">Administrator Email</span>
          <input
            type="email"
