        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-4">
              <img src={glaLogo} alt="GLA University" className="h-12 sm:h-14 w-auto object-contain" loading="lazy" />
              <div className="h-8 w-px bg-[#DDD7C9]" />
              <img src={saturangleLogo} alt="Saturangle — The Debate Club" className="h-10 sm:h-12 w-auto object-contain" loading="lazy" />
            </div>
            <div className="pt-2">
